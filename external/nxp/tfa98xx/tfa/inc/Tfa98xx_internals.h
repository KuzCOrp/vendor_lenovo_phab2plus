...
#define FW_PAR_ID_GET_TAG                   0xFF       /**< ParamId for Get Tag */
#define FW_PAR_ID_GLOBAL_GET_INFO   0x84      /**< ParamId for Get Info */
#define FW_PAR_ID_SET_CURRENT_DELAY 0x03     /**< ParamId for Set Delay */
#define FW_PAR_ID_WRITE_TO_MEMORY   0x04  /**< ParamId for Write Memory */
#define FW_PAR_ID_READ_FROM_MEMORY  0x05   /**< ParamId for Read Memory */
#define FW_PAR_ID_SET_CURFRAC_DELAY 0x06/**< ParamId for Set Frac Delay */
#define FW_PAR_ID_GET_FEATURE_BITS  0x85 /**< ParamId for Get Feat.bits */
