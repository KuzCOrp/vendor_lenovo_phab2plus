 ...
 */
void tfa98xxPrintRecordHeader(Tfa98xx_handle_t *handlesIn, char *csv, int mstime);
 ...
 *  @return last error code
 */
tfa_srv_api_error_t nxpTfa98xxLiveDataSlaves(int i2cbase, int maxdevices);
...
int tfa98xxPrintSpeakerModel(Tfa98xx_handle_t *handlesIn,
                              char* csv, int xmodel, int idx, int maxdev);
/*
 *
 */
 ...
 *  @return last error code
 */
tfa_srv_api_error_t nxpTfa98xxGetLiveData(nxpTfa98xx_LiveData_t * record);
 ...
 *  @return last error code
 */
tfa_srv_api_error_t nxpTfa98xxSendSpeakerStateInfo(int msInterval, int
