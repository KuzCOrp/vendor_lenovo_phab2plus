...
status_t AudioALSACaptureHandlerNormal::open()
{
	...
	//ALOGD("STT: AudioALSACaptureHandlerNormal::open mStreamAttributeTarget->mAudioInputFlags=%d\n", mStreamAttributeTarget->mAudioInputFlags);
	mHardwareResourceManager->startInputDevice(mStreamAttributeTarget->input_device, mStreamAttributeTarget->mAudioInputFlags);
...
status_t AudioALSACaptureHandlerNormal::close()
{
	...
	//ALOGD("STT: AudioALSACaptureHandlerNormal::close mStreamAttributeTarget->mAudioInputFlags=%d\n", mStreamAttributeTarget->mAudioInputFlags);
    mHardwareResourceManager->stopInputDevice(mHardwareResourceManager->getInputDevice(), mStreamAttributeTarget->mAudioInputFlags);
