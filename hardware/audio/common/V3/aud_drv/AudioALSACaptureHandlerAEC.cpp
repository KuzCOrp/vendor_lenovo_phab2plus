...
//++Modified by shentaotato 2016.06.12 for VOIP
	if (mStreamAttributeTarget->output_devices == AUDIO_DEVICE_OUT_EARPIECE)//receiver
	{
		mStreamAttributeTarget->input_device = AUDIO_DEVICE_IN_VOIP_EARPIECE;
	}
	else if (mStreamAttributeTarget->output_devices == AUDIO_DEVICE_OUT_WIRED_HEADPHONE)//headphone
	{
		mStreamAttributeTarget->input_device = AUDIO_DEVICE_IN_VOIP_HEADPHONE;
	}
	else if (mStreamAttributeTarget->output_devices == AUDIO_DEVICE_OUT_SPEAKER)//speaker
	{
		mStreamAttributeTarget->input_device = AUDIO_DEVICE_IN_VOIP_SPEAKER;
	}
