...
class AudioALSAHardwareResourceManager
{
    public:
        ...
        virtual status_t startInputDevice(const audio_devices_t new_device, audio_input_flags_t flags = (audio_input_flags_t)0);
        virtual status_t stopInputDevice(const audio_devices_t stop_device, audio_input_flags_t flags = (audio_input_flags_t)0);
