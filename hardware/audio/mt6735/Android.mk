...
ifeq ($(strip $(ADNC_OK_GOOGLE_KW)), yes)
	LOCAL_CFLAGS += -DADNC_OK_GOOGLE
endif

ifneq ($(strip $(ADNC_OK_GOOGLE_KW)), yes)
	LOCAL_CFLAGS += -UADNC_OK_GOOGLE
endif
# --Audience CVQ implementation--

LOCAL_SRC_FILES+= \
    $(LOCAL_COMMON_PATH)/aud_drv/audio_hw_hal.cpp \
    $(LOCAL_COMMON_PATH)/aud_drv/CVQStream.c \
...
# for OFFLOAD start
    LOCAL_SRC_FILES+= \
        $(LOCAL_COMMON_PATH)/aud_drv/AudioMTKDec.cpp \
        $(LOCAL_COMMON_PATH)/V3/aud_drv/AudioALSAPlaybackHandlerOffload.cpp
    LOCAL_STATIC_LIBRARIES+= libmp3dec_mtk
# Offload End
endif
